...
public abstract class MarkerView extends RelativeLayout {
     ...
     *
     * @param e The Entry the MarkerView belongs to. This can also be any subclass of Entry, 
     ...
     * as it's dataset-index, the selected indexRange or stack-index (only stacked bar entries).
     */
     ...
     * returning -(getWidth() / 2) you will center the MarkerView horizontally.
     *
     ...
     * By returning -getHeight() you will cause the MarkerView to be above the selected value.
     *
